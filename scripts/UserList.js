...
class UserList {
    ...
    add(newUser) {
        if (typeof newUser === 'object' && typeof newUser !== null && newUser.first_name) {
    ...
    removeById(id) {
        ...
        users.splice(foundUser.id, 1);
        console.log(`bye bye ${foundUser.first_name}`);
        return this;
    }

    logUsersCount() {
        console.log(`Total user count is: ${users.length}`);
        return this;
    }
}
